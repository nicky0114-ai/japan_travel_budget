    ...
    childTxs.forEach(tx => {
        ...
        item.innerHTML = `
            ...
            <div class="history-item-right">
                ...
                <button class="card-icon-btn" style="margin-right: 6px;" onclick="editTransaction('${tx.id}', false); event.stopPropagation();">✏️</button>
    ...
    filtered.forEach(tx => {
        ...
        item.innerHTML = `
            ...
            <div class="history-item-right">
                ...
                <button class="card-icon-btn" style="margin-right: 6px;" onclick="editTransaction('${tx.id}', true); event.stopPropagation();">✏️</button>
...
function editTransaction(id, isParentView) {
    try {
        ...
        // 設定日期時間 (轉為 YYYY-MM-DDThh:mm，採用純手動字串格式化，避免任何瀏覽器時區轉換溢出錯誤)
